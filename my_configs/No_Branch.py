...
# 1. Standard Cache and Memory Subsystems
...
# 2. Processor Core (TimingSimpleCPU = No Speculative Branch Prediction)
...
print("Executing Single-Issue Pipeline Baseline (No Branch Prediction)...")
simulator.run()
